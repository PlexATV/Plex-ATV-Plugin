...
+ (NSDictionary*)defaultValues {
    return [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            [NSNumber numberWithInt:10], PreferencesPlaybackVideoQualityProfile,
            [NSNumber numberWithInt:7], PreferencesPlaybackVideoQualityRemoteProfile,
            [NSNumber numberWithInt:2], PreferencesPlaybackVideoDirectPlayQuality,
